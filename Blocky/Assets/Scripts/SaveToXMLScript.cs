...
public class SaveToXMLScript : MonoBehaviour
{
    ...
    public void OpenLoadMenu()
    {
        ...
        if (!loadSlots.activeInHierarchy)
        {
            ...
            Texture2D screenshot = LoadTexture("Blocky_Data/Saves/saveScreenshot1.png");
            if (screenshot != null)
            {
            ...
            Texture2D screenshot2 = LoadTexture("Blocky_Data/Saves/saveScreenshot2.png");
            if (screenshot2 != null)
            {
            ...
            Texture2D screenshot3 = LoadTexture("Blocky_Data/Saves/saveScreenshot3.png");
            if (screenshot3 != null)
            {
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    public void LoadLevel(int levelNumber, string groundType)
    {
        cubesToSpawnList = ReadFloorFromXML("ground" + groundType);
        houseCubesList = ReadHouseCubesFromXML("house" + groundType);
    ...
    public List<CubeType> ReadLevelFile(string filename)
    {
        ...
        while (reader.Read())
        {
            if (reader.IsStartElement("Features"))
            {
                ...
                {
                    if (innerReader.IsStartElement("Feature1"))
                    {
                        feature1.text = innerReader.ReadString().ToUpper();
                    }
                    if (innerReader.IsStartElement("Feature2"))
                    {
