...
public class GameData : MonoBehaviour
{
    ...
    public float backgroundAudioLevel = 0.5f;
    public float cubePlacementAudioLevel = 0.2f;
    public int levelChosen = 0;
    public string groundChosen;
    ...
    void Update()
    {
        ...
        if (levelChosen != 0 && hasLoaded == false)
        {
            if (GameObject.Find("SaveObject") !=null)
            {
                ...
                {
                    GameObject.Find("SaveObject").GetComponent<SaveToXMLScript>().LoadLevel(levelChosen, groundChosen);
                    hasLoaded = true;
                }
            }
