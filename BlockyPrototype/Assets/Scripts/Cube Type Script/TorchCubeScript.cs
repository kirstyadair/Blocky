...
public class TorchCubeScript : MonoBehaviour
{
    ...
    void OnTriggerEnter(Collider other)
    {
        ...
        {
            if (other.GetComponent<TorchCubeScript>().timeActive == timeActive)
            {
                other.GetComponent<TorchCubeScript>().timeActive += 0.01f;
            }
