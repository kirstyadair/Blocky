...
public class RainbowLightCubeScript : MonoBehaviour
{
    ...
    void Start()
    {
        gameObject.name = "RainbowLightCube";
    ...
    void OnTriggerEnter(Collider other)
    {
        ...
        {
            if (other.GetComponent<RainbowLightCubeScript>().timeActive == timeActive)
            {
                other.GetComponent<RainbowLightCubeScript>().timeActive += 0.01f;
            }
